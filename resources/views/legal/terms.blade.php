    ...
    <div class="max-w-4xl mx-auto px-5 sm:px-8 py-14 grid lg:grid-cols-[220px_1fr] gap-12">
        ...
        <article class="prose-legal max-w-none text-gray-700 leading-relaxed [&>section]:mb-12">
            ...
            <section id="layanan">
                ...
                <p>Dialogen adalah aplikasi permainan kuis multiplayer real-time bertema bahasa daerah Indonesia. Layanan memungkinkan pengguna untuk membuat atau bergabung ke dalam room permainan, menjawab pertanyaan seputar bahasa daerah, berkomunikasi melalui message chat, dan melihat papan skor bersama pemain lain.</p>
            ...
            <section id="perilaku">
                <h2 class="text-xl font-extrabold text-brand-navy mb-4">3. Aturan Perilaku Pengguna</h2>
                ...
                <ul class="list-disc pl-5 space-y-1.5 mt-3">
                    ...
                    <li>Melakukan pelecehan, intimidasi, ujaran kebencian, atau perundungan terhadap pengguna lain, melalui message chat.</li>
            ...
            <section id="konten">
                <h2 class="text-xl font-extrabold text-brand-navy mb-4">4. Konten & Kekayaan Intelektual</h2>
            ...
            <section id="tanggung-jawab">
                <h2 class="text-xl font-extrabold text-brand-navy mb-4">5. Batasan Tanggung Jawab</h2>
                ...
                <ul class="list-disc pl-5 space-y-1.5 mt-3">
                    ...
                    <li>Konten atau perilaku pengguna lain selama sesi message chat maupun interaksi dalam room permainan.</li>
            ...
            <section id="perubahan-layanan">
                <h2 class="text-xl font-extrabold text-brand-navy mb-4">6. Perubahan Layanan & Ketentuan</h2>
            ...
            <section id="hukum">
                <h2 class="text-xl font-extrabold text-brand-navy mb-4">7. Hukum yang Berlaku</h2>
            ...
            <section id="kontak-tos" class="!mb-0">
                <h2 class="text-xl font-extrabold text-brand-navy mb-4">8. Hubungi Kami</h2>
